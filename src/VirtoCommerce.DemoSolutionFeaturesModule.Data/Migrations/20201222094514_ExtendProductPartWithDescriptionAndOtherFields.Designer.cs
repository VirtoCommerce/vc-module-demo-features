...
namespace VirtoCommerce.DemoSolutionFeaturesModule.Data.Migrations
{
    ...
    [Migration("20201222094514_ExtendProductPartWithDescriptionAndOtherFields")]
    partial class ExtendProductPartWithDescriptionAndOtherFields
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("VirtoCommerce.DemoSolutionFeaturesModule.Data.Models.Catalog.DemoProductPartEntity", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("nvarchar(128)")
                    ...
                    b.Property<string>("ConfiguredProductId")
                        .IsRequired()
                        .HasColumnType("nvarchar(128)")
                        .HasMaxLength(128);
                    ...
                    b.ToTable("DemoProductPart");
                });

            modelBuilder.Entity("VirtoCommerce.DemoSolutionFeaturesModule.Data.Models.Catalog.DemoProductPartItemEntity", b =>
                {
                    b.Property<string>("ConfiguredProductPartId")
                        .HasColumnType("nvarchar(128)")
                        .HasMaxLength(128);
                    ...
                    b.HasKey("ConfiguredProductPartId", "ItemId");
            ...
            modelBuilder.Entity("VirtoCommerce.DemoSolutionFeaturesModule.Data.Models.Catalog.DemoItemEntity", b =>
                {
                    b.HasBaseType("VirtoCommerce.CatalogModule.Data.Model.ItemEntity");

                    b.HasDiscriminator().HasValue("DemoItemEntity");
                });
            ...
            modelBuilder.Entity("VirtoCommerce.DemoSolutionFeaturesModule.Data.Models.Catalog.DemoProductPartEntity", b =>
                {
                    b.HasOne("VirtoCommerce.DemoSolutionFeaturesModule.Data.Models.Catalog.DemoItemEntity", "ConfiguredProduct")
                        .WithMany("ConfiguredProductParts")
            ...
            modelBuilder.Entity("VirtoCommerce.DemoSolutionFeaturesModule.Data.Models.Catalog.DemoProductPartItemEntity", b =>
                {
                    b.HasOne("VirtoCommerce.DemoSolutionFeaturesModule.Data.Models.Catalog.DemoProductPartEntity", "ConfiguredProductPart")
                        .WithMany("PartItems")
                        .HasForeignKey("ConfiguredProductPartId")
                        .OnDelete(DeleteBehavior.ClientCascade)
                        .IsRequired();

                    b.HasOne("VirtoCommerce.DemoSolutionFeaturesModule.Data.Models.Catalog.DemoItemEntity", "Item")
                        .WithMany("PartItems")
                        .HasForeignKey("ItemId")
                        .OnDelete(DeleteBehavior.ClientCascade)
                        .IsRequired();
