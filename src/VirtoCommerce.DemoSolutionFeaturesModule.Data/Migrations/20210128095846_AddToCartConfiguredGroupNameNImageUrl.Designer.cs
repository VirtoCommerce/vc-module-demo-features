...
namespace VirtoCommerce.DemoSolutionFeaturesModule.Data.Migrations
{
    ...
    [Migration("20210128095846_AddToCartConfiguredGroupNameNImageUrl")]
    partial class AddToCartConfiguredGroupNameNImageUrl
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("VirtoCommerce.CartModule.Data.Model.ShoppingCartEntity", b =>
                {
                    ...
                    b.HasDiscriminator<string>("Discriminator").HasValue("ShoppingCartEntity");
                });
            ...
            modelBuilder.Entity("VirtoCommerce.DemoSolutionFeaturesModule.Data.Models.DemoCartConfiguredGroupEntity", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("nvarchar(128)")
                    ...
                    b.ToTable("DemoCartConfiguredGroup");
                });

            modelBuilder.Entity("VirtoCommerce.DemoSolutionFeaturesModule.Data.Models.DemoCartLineItemEntity", b =>
                {
                    b.HasBaseType("VirtoCommerce.CartModule.Data.Model.LineItemEntity");

                    b.Property<string>("ConfiguredGroupId")
                        .HasColumnType("nvarchar(128)")
                        .HasMaxLength(128);

                    b.HasIndex("ConfiguredGroupId");

                    b.HasDiscriminator().HasValue("DemoCartLineItemEntity");
                });

            modelBuilder.Entity("VirtoCommerce.DemoSolutionFeaturesModule.Data.Models.DemoShoppingCartEntity", b =>
                {
                    b.HasBaseType("VirtoCommerce.CartModule.Data.Model.ShoppingCartEntity");

                    b.HasDiscriminator().HasValue("DemoShoppingCartEntity");
                });
            ...
            modelBuilder.Entity("VirtoCommerce.DemoSolutionFeaturesModule.Data.Models.DemoCartConfiguredGroupEntity", b =>
                {
                    b.HasOne("VirtoCommerce.DemoSolutionFeaturesModule.Data.Models.DemoShoppingCartEntity", "ShoppingCart")
                        .WithMany("ConfiguredGroups")
                        .HasForeignKey("ShoppingCartId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("VirtoCommerce.DemoSolutionFeaturesModule.Data.Models.DemoCartLineItemEntity", b =>
                {
                    b.HasOne("VirtoCommerce.DemoSolutionFeaturesModule.Data.Models.DemoCartConfiguredGroupEntity", "ConfiguredGroup")
                        .WithMany("Items")
                        .HasForeignKey("ConfiguredGroupId")
