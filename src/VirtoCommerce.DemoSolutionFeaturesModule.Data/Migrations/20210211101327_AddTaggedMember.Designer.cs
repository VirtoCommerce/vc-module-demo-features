...
namespace VirtoCommerce.DemoSolutionFeaturesModule.Data.Migrations
{
    ...
    [Migration("20210211101327_AddTaggedMember")]
    partial class AddTaggedMember
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("VirtoCommerce.DemoSolutionFeaturesModule.Data.Models.Customer.DemoMemberTagEntity", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("nvarchar(128)")
                    ...
                    b.Property<string>("TaggedMemberId")
                        .IsRequired()
                        .HasColumnType("nvarchar(128)")
                        .HasMaxLength(128);
                    ...
                    b.HasIndex("TaggedMemberId");

                    b.ToTable("DemoMemberTag");
                });

            modelBuilder.Entity("VirtoCommerce.DemoSolutionFeaturesModule.Data.Models.Customer.DemoTaggedMemberEntity", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(128)")
                        .HasMaxLength(128);
            ...
            modelBuilder.Entity("VirtoCommerce.DemoSolutionFeaturesModule.Data.Models.ContactDemoEntity", b =>
                {
                    ...
                    b.HasDiscriminator().HasValue("ContactDemoEntity");
                });
            ...
            modelBuilder.Entity("VirtoCommerce.DemoSolutionFeaturesModule.Data.Models.Customer.DemoMemberTagEntity", b =>
                {
                    b.HasOne("VirtoCommerce.DemoSolutionFeaturesModule.Data.Models.Customer.DemoTaggedMemberEntity", "TaggedMember")
                        .WithMany("Tags")
                        .HasForeignKey("TaggedMemberId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("VirtoCommerce.DemoSolutionFeaturesModule.Data.Models.Customer.DemoTaggedMemberEntity", b =>
                {
                    b.HasOne("VirtoCommerce.CustomerModule.Data.Model.MemberEntity", "Member")
                        .WithOne()
                        .HasForeignKey("VirtoCommerce.DemoSolutionFeaturesModule.Data.Models.Customer.DemoTaggedMemberEntity", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
